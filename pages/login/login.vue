...
<script>
	import  {s_loginUrl}  from  '@/common/js/config.js'
				...
				uni.request({
					...
					success: (res) => {
						if(res.data.code == 200){
							...
							this.$store.commit('set_horn', res.data.data.horn);
							uni.setStorage({
							    key: 'words',
						...
						this.toMain(this.account, res.data.data.token);
					},
					fail: (err) => {
